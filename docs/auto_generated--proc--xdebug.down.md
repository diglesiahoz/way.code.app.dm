...
task:
  ...
  do:
    ...
    - { call: exec, args: { cmd: 'docker exec -it (({origin}.appsetting.tag))-www sudo phpdismod -s cli xdebug', out: true } }
    ...
    - { call: exec, args: { cmd: 'docker exec -it (({origin}.appsetting.tag))-www sudo service php(({origin}.appsetting.service.www.php.release))-cli reload', out: false } }
