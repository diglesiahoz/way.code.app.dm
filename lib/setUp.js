  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      (async function() {
        ...
        way.var.setup_compose_cmd = `[ ! -f ../.env ] && touch ../.env; export COMPOSE_BAKE=true;${way.var.setup_compose_cmd} up ${extra_opt} --force-recreate --build && echo && docker ps --filter name=^/(({origin}.appsetting.tag)) && echo`;
