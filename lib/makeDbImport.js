  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      (async function() {
        ...
        // // Vacia tablas
        // if (way.opt.drop) {
        //   if (_args.env_key != 'local' && !way.opt.d) {
        //     way.opt.y = false;
        //   }
        //   await way.lib.ask({
        //     message: `Are you sure you want to drop all tables from "${_args.env_key}:${_args.host}/${_args.name}"?`,
        //     exitIfNegative: true
        //   });
        //   way.var.tables = '';
        ...
        //     }
        //   });
        //   way.lib.logRunning(`Deleting data from database "${_args.env_key}:${_args.host}/${_args.name}"`);
