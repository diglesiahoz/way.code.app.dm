  ...
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      (async function() {
        ...
        var origin_sig = `color.${origin_primary_env_color}("${origin._env}:${origin.appsetting.service.db.host.sv}/${origin.appsetting.service.db.name}")`;
        var target_sig = `color.${target_primary_env_color}("${target._env}:${target.appsetting.service.db.host.sv}/${target.appsetting.service.db.name}")`;
