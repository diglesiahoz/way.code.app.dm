way.lib.dm.makeDrupal = async function (_args){
  var _args = way.lib.getArgs('dm.makeDrupal', _args);
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      (async function() {
        ...
        console.log(envThis)
        console.log('=======');
        console.log(envThis.appsetting.wildcard_host)
        console.log(envThis.appsetting.service.db)
        console.log(envThis.appsetting.service.www.drupal.multisite)
